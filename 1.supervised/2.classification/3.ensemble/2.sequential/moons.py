...
def main():
    ...
    classifiers = [AdaBoostClassifier(n_estimators=5), GradientBoostingClassifier(n_estimators=5)]
    for cls in classifiers:
        cls.fit(x_train, y_train)

        # Plot intermediate trees.
        if isinstance(cls, AdaBoostClassifier):
        ...
        if isinstance(cls, GradientBoostingClassifier):
            ...
            cls_axis = axes # axis located in last row / column.
...
if __name__ == '__main__':
    # https://openclassrooms.com/fr/courses/4470521-modelisez-vos-donnees-avec-les-methodes-ensemblistes/4664692-initiez-vous-aux-methodes-sequentielles-et-au-boosting
    main()
